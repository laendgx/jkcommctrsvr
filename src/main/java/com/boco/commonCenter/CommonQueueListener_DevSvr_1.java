...
//@Component
//@RabbitListener(queues = "${devsvrQueueName_1}")
public class CommonQueueListener_DevSvr_1 {
    private static final Logger logger= LoggerFactory.getLogger(CommonQueueListener_DevSvr_1.class);

    @RabbitHandler
    public void process(String Protocolbody) {
        try {
            System.out.println("CommonQueueListener_DevSvr_1_rev-->" + Protocolbody);
            ...
            System.out.println("CommonQueueListener_DevSvr_1_Protocolbodytest-->getBusinessno: " + busno);
