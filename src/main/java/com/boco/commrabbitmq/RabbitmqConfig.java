...
public class RabbitmqConfig {
    ...
    /**
     * 创建设备采集服务接收队列信息，这里有多少个设备采集服务需配置多少个
     * @return
     */
    @Bean
    public Queue devCollrevDirectQueue() {
        return new Queue(env.getProperty("devCollrevQueueName"),true);  //true 是否持久
    }
    ...
    Binding bindingDirect() {
        return BindingBuilder.bind(devCollrevDirectQueue()).to(DirectExchange()).with(env.getProperty("devCollrevQueueKey"));
    }
